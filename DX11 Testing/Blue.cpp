...
bool Blue::setOption(std::string text, std::string Rtext, std::string DEC)
{
...
void Blue::End(std::string SubTitle)
{
		...
		Blues_UI->Text("Version: Blue | " + SubTitle, Blues_UI->TextOnNomral, TextPos);
