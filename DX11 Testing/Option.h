...
bool Float(std::string text, float& Main, float min, float max, float step = 1.f, std::string DEC = "No description.");
bool Int(std::string text, int& Main, int min, int max, int step = 1, std::string DEC = "No description.");
